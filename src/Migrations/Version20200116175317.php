 ...
 */
final class Version20200116175317 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, adhesion_id INT DEFAULT NULL, username VARCHAR(191) NOT NULL, password VARCHAR(70) NOT NULL, date_crea DATETIME NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D649F68139D7 (adhesion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adhesion (id INT AUTO_INCREMENT NOT NULL, image_id INT DEFAULT NULL, gender TINYINT(1) NOT NULL, statut TINYINT(1) NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, lieu_naissance VARCHAR(255) DEFAULT NULL, nationnalite VARCHAR(255) DEFAULT NULL, nature_identite VARCHAR(255) DEFAULT NULL, number_identity VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, pays VARCHAR(255) DEFAULT NULL, codepostale VARCHAR(5) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, profession VARCHAR(255) DEFAULT NULL, birthday DATE DEFAULT NULL, dateadhesion DATETIME DEFAULT NULL, dateecheancebis DATETIME DEFAULT NULL, norue VARCHAR(255) DEFAULT NULL, nomrue VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_C50CA65A3DA5256D (image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fpilyon (id INT AUTO_INCREMENT NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, selection TINYINT(1) DEFAULT NULL, remarque VARCHAR(255) DEFAULT NULL, selectiontest TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE fpilyon');
    }
}
